...
public class Kontak extends AppCompatActivity {
    ...
    private kontakAdapterudin uAdapter;
    String sNama, sNomor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uAdapter = new kontakAdapterudin(this, 0, listKontak);
    ...
    public class kontakAdapterudin extends ArrayAdapter<KontakSuper> {
